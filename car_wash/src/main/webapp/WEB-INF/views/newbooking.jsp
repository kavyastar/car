...
<h4 style="color:red">${msg}</h4>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form class="user" action="makebook" enctype="multipart/form-data" method="Post">
                         <input type="hidden" name="email" value="${email}">
                                <div class="form-group ">
                                     <label for="booking_date"> booking date      </label> <br> <br> 
                                        <input type="date" name="booking_date"  min="<%= LocalDate.now()%>" max="<%=LocalDate.now().plusDays(5)%>"><br><br> 
   
                                </div>
                                <div class="form-group ">
                                <label for="start_time">Time</label><br> <br> 
                                ...
                                <div class="form-group ">
                                <label for="car_number">Car number</label><br> <br>
                                ...
                                <div class="form-group ">
                                <label for="car_type">Car type</label><br> <br>
                                <select name="car_type">
                                 <c:forEach items="${list}" var="m">
									
									
									<option value="${m.getCost_id()}">${m.getCar_type()}</option>
                                 ...
                                 <input type="submit" class="btn btn-primary btn-user btn-block" value ="Book">
                                <hr>
                           </form>
                        </div>
                    </div>
